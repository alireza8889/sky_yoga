...
class ChooseInjuriesBack extends StatefulWidget {
  const ChooseInjuriesBack({super.key});

  @override
  State<ChooseInjuriesBack> createState() => _ChooseInjuriesBackState();
}

class _ChooseInjuriesBackState extends State<ChooseInjuriesBack> {
  int isSelected = 0;
  List<String> items = [
    'Spasm',
    'Soreness',
